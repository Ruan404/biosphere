...
<head>
  <meta charset="UTF-8">
  <title> Biosphere page d'acceuil </title>
...
<body>
  ...
  <main>
    <div class="image-container">
      <img src="logo_biosphere.png" alt="Logo Biosphère">
    </div>
    <div class="text-container">
      <p>Ce HotSpot fonctionne à l'énergie solaire, ce qui signifie qu'il est parfois hors ligne.
        <br>
        Le soir, c’est sur batterie !
        <br>
        Ce réseau intranet est hébergé à la Biosphère Urbaine, un projet expérimental
        <br> d’appartement-laboratoire explorant la ville Low-Tech du futur.
        <br>Sur ce réseau, vous trouverez les actualités de la semaine, une boîte de dialogue
        <br> entre voisins, vos meilleures recettes partagées, des films et documentaires en
        <br>open-source, Wikipédia, et bien sûre, le wiki des tutoriels low-tech!
        <br>Bonne découverte,
        <br>L’équipe de BIOSPHERE-EXPERIENCE
      </p>
    </div>
  </main>
